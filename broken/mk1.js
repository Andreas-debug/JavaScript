function param1(vm, y, pixels, imagedata, pixelsPerDatapoint){
    var all = [];
    setTimeout(function()
    {
        pixels = [];
        for(var x = 0; x < vm.width; x += (vm.width * pixelsPerDatapoint) / vm.width)
        {
...
function param2(a, selected, all, characters, cb)
{
    var endString = ""
    setTimeout(function()
    {
...
function readURL(){
    ...
    inp.onload = function() {  
        ...
        for(var y = 0; y < inp.height; y += (inp.height * pixelsPerDatapoint) / inp.height)
        {
            ...
            var vm = inp;
            all.push(param1(vm, y, pixels, imagedata, pixelsPerDatapoint));
        }
        ...
        for(var a = 0; a < all.length; a++)
        {
            ...
            endString = "";
            endString = param2(a, selected, all, characters, cb = function(endString){return endString});
            endString += '<br>';
